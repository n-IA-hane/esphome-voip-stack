...
- `signaling_buffers_in_psram: true` stores retained SIP/SDP transaction
  payloads in PSRAM. Timers, locks, socket state and realtime media remain in
  internal RAM. This option requires the ESPHome `psram` component.
